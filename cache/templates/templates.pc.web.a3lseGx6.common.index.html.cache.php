 ...
 */
        ...
        .navi_openIcon {
            background: url("/<?php echo HOME_THEME_PATH; ?>images/navi/nav_open.png") center center;
            background-repeat: no-repeat;
            background-size: 100%;
        }
        .navi_closeIcon {
            background: url("/<?php echo HOME_THEME_PATH; ?>images/navi/nav_close.png") center center;
            background-repeat: no-repeat;
            background-size: 100%;
        }
        /*图文可选中*/
        ...
        .price[data-v-7536231f] {
            ...
            font-size: 0.28rem;
            vertical-align: top;
            background: url(/<?php echo HOME_THEME_PATH; ?>images/coupon/pic-coupon-bg.png);
        ...
        .content-main>.footer[data-v-4031cc43] {
            margin-top: 0.22rem;
            text-align: center;
        }
        </style>
        ...
        <!--auth：pioneer  effect：点击课程列表可以跳转到详情页面-->
        <script>
        $(function(){
            $(".kechengliebiao").each(function(){
                $(this).bind('click',function(){
                    var id = $(this).attr("id");
                    window.location.href='<?php echo SITE_URL; ?>index.php/?s=mall&c=show&m=xiangqingye&id=' + id;
                });
            });
        });
        </script>
    <script>
        $(function(){
            $("#search_text").blur(function(){
                ...
                window.location.href="<?php echo SITE_URL; ?>?text=" + text;
            })
        })
    </script>
    </head>
    ...
    <body>
        ...
        .navi_home {
            ...
            margin-left: 0;
            margin-top: -.12rem;
            background: url(/<?php echo HOME_THEME_PATH; ?>images/navi/homeButtonIcon.png) center center;
            background-repeat: no-repeat;
            background-size: 100%
        }
        .navi_home_txt {
        ...
        <div class="homeWrapper">
            <div class="page_wrapper">
                <div style="">
                    <div class="content-list canTouchMove">
                        <div data-v-2477b5de="">
                            <div data-v-2477b5de="" class="search_wrapper">
                                <div data-v-2477b5de="" class="search_text EC7 ET5">
                                    <img data-v-2477b5de="" src="<?php echo HOME_THEME_PATH; ?>images/icon_search.png" class="search_icon">
                                        <input type="text" placeholder="<?php echo $text; ?>"  id="search_text" style="background-color: transparent;border: none;outline:none;" />
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="activityPart">
                                <div class="contentList-title t1 c2"><span class="partTitle">课程</span>
                                </div>
                                
                                <!--这里遍历所有的课程-->
                                <!--<?php $return_a = array();$list_temp_a = $this->list_tag("action=module module=mall order=updatetime num=6  return=a"); if ($list_temp_a) extract($list_temp_a); $count_a=count($return_a); if (is_array($return_a)) { foreach ($return_a as $key_a=>$a) { ?>-->
                                <!--  <div class="kechengliebiao" id="<?php echo $a['id']; ?>">-->
                                <!--    <div data-v-25593c85="" class="listWrapper">-->
                                <!--         <a data-v-25593c85="" class="content-wrapper pressWrapper pressGreyBg">-->
                                <!--              <div data-v-25593c85="" class="contentMain">-->
                                <!--                  <div data-v-25593c85="" class="content-pic-wrapper"><span data-v-25593c85="" class="activity_text    c_green_normal t8"><?php echo dr_cat_value('1-mall', $a['catid'], 'name'); ?></span> -->
                                <!--                      <img data-v-25593c85="" src="<?php echo dr_thumb($a['thumb'][0]); ?>" class="content-pic">-->
                                <!--                  </div>-->
                                                  
                                <!--                  <div data-v-25593c85="" class="content-info"><span data-v-25593c85="" class="content-title t2 c2"><?php echo $a['title']; ?></span>-->

                                <!--                     <div data-v-25593c85="" class="content-status">-->
                                <!--                       <div data-v-25593c85="" class="t4 c3"><span data-v-25593c85="">活动时间：</span>  <span data-v-25593c85=""><?php echo $a['updatetime']; ?></span>-->
                                <!--                       </div>-->
                                <!--                     </div>-->
                                <!--                 </div>-->
                                <!--              </div>-->
                                ...
                                <?php if ($data) {  if (is_array($data)) { $count=count($data);foreach ($data as $a) { ?>
                                    <div class="kechengliebiao" id="<?php echo $a['id']; ?>">
                                        <div data-v-25593c85="" class="listWrapper">
                                             <a data-v-25593c85="" class="content-wrapper pressWrapper pressGreyBg">
                                                  <div data-v-25593c85="" class="contentMain">
                                                      <div data-v-25593c85="" class="content-pic-wrapper"><span data-v-25593c85="" class="activity_text    c_green_normal t8"><?php echo dr_cat_value('1-mall', $a['catid'], 'name'); ?></span> 
                                                          <img data-v-25593c85="" src="<?php echo dr_thumb(substr($a['thumb'],2, -2)); ?>" class="content-pic">
                                                      </div>
                                    ...
                                    <div >
                                        <div data-v-25593c85="" class="listWrapper">
                                             <a data-v-25593c85="" class="content-wrapper pressWrapper pressGreyBg">
                                                 <div data-v-25593c85="" class="contentMain">
                                                     <div data-v-25593c85="" class="content-info"><span data-v-25593c85="" class="content-title t2 c2">未查询到匹配的结果！</span>
                                                     </div>
                                                 </div>
                                            </a>
                                        </div>
                        ...
                        <div data-v-20ffbaa0="" class="recommend-part">
