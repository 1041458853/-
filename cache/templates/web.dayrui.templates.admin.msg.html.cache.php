...
<!-- END HEAD -->
<body class=" page-404-full-page" style="display: none">
<div class="row">
	<div class="col-md-12 page-404">
		<?php if ($mark==1) { ?>
		<div class="number font-green-turquoise" style="top: 10px;font-size: 88px;"> <i class="fa fa-check-circle-o"></i> </div>
		<?php } else if ($mark==2) { ?>
		<div class="number font-blue" style="top: 10px;font-size: 88px;"> <i class="fa  fa-info-circle"></i> </div>
		<?php } else { ?>
		<div class="number font-red" style="top: 10px;font-size: 88px;"> <i class="fa fa-times-circle-o"></i> </div>
		<?php } ?>
		<div class="details">
			<h4><?php echo $msg; ?></h4>
...
<?php if ($fn_include = $this->_include("common_js.html", "/")) include($fn_include); ?>
</body>
</html>