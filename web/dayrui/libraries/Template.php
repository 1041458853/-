...
class Template {
    ...
    public function __construct() {
        ...
        $this->_root_array = array(
            ...
            'client1' => TPLPATH.'client1/web/'.SITE_TEMPLATE.'/common/',
            'client2' => TPLPATH.'client2/web/'.SITE_TEMPLATE.'/common/',
            'client3' => TPLPATH.'client3/web/'.SITE_TEMPLATE.'/common/',
            'client4' => TPLPATH.'client4/web/'.SITE_TEMPLATE.'/common/',
            'client5' => TPLPATH.'client5/web/'.SITE_TEMPLATE.'/common/',
        );
        // 默认会员项目模板目录
        $this->_mroot_array = array(
            'pc' => TPLPATH.'pc/member/'.MEMBER_TEMPLATE.'/common/',
            'mobile' => TPLPATH.'mobile/member/'.MEMBER_TEMPLATE.'/common/',
            'client1' => TPLPATH.'client1/member/'.MEMBER_TEMPLATE.'/common/',
            'client2' => TPLPATH.'client2/member/'.MEMBER_TEMPLATE.'/common/',
            'client3' => TPLPATH.'client3/member/'.MEMBER_TEMPLATE.'/common/',
            'client4' => TPLPATH.'client4/member/'.MEMBER_TEMPLATE.'/common/',
            'client5' => TPLPATH.'client5/member/'.MEMBER_TEMPLATE.'/common/',
        );
        // 默认后台模板目录
        ...
        if (IS_ADMIN) { // 后台
            ...
            if (APP_DIR != 'member') { // 模块和应用的会员目录
                ...
                $this->_module_root_array = array(
                    ...
                    'client1' => TPLPATH.'client1/member/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                    'client2' => TPLPATH.'client2/member/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                    'client3' => TPLPATH.'client3/member/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                    'client4' => TPLPATH.'client4/member/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                    'client5' => TPLPATH.'client5/member/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                );
            ...
            $this->_module_root_array = array(
                ...
                'client1' => TPLPATH.'client1/web/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                'client2' => TPLPATH.'client2/web/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                'client3' => TPLPATH.'client3/web/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                'client4' => TPLPATH.'client4/web/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
                'client5' => TPLPATH.'client5/web/'.SITE_TEMPLATE.'/'.APP_DIR.'/',
            );
            $this->_dir = $this->_module_root_array[$this->_tname];
        } else { // 首页前端页面
