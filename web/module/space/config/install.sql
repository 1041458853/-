...
REPLACE INTO `{dbprefix}space_category` (`id`, `uid`, `pid`, `pids`, `type`, `name`, `link`, `body`, `showid`, `modelid`, `child`, `childids`, `title`, `keywords`, `description`, `displayorder`) VALUES(1, 1, 0, '0', 2, '关于我们', '', '', 3, 0, 1, '1,2,3', '', '', '', 0),(2, 1, 1, '0,1', 2, '空间简介', '', '<p>ImtCMS v2（简称v2）是一款开源的跨平台网站内容管理系统，以“实用+好用”为基本产品理念，提供从内容发布、组织、传播、互动和数据挖掘的网站一体化解决方案。系统基于CodeIgniter框架，具有良好扩展性和管理性，可以帮助您在各种操作系统与运行环境中搭建各种网站模型而不需要对复杂繁琐的编程语言有太多的专业知识，系统采用UTF-8编码，采取(语言-代码-程序)两两分离的技术模式，全面使用了模板包与语言包结构，为用户的修改提供方便，网站内容的每一个角落都可以在后台予以管理，是一套非常适合用做系统建站或者进行二次开发的程序核心。<br /></p>', 3, 0, 0, '2', '', '', '', 0),(3, 1, 1, '0,1', 2, '联系我们', '', '<p><img src="http://api.map.baidu.com/staticimage?center=104.077889,30.551305&zoom=18&width=530&height=340&markers=104.076658,30.551693" height="340" width="530" /></p><p>扣扣咨询：135977378<br />电子邮箱：ImtCMS@qq.com</p>', 3, 0, 0, '3', '', '', '', 0),(4, 1, 0, '0', 1, '新闻资讯', '', '', 3, 1, 0, '4', '', '', '', 0),(5, 1, 0, '0', 1, '我的日志', '', '', 3, 3, 0, '5', '', '', '', 0),(6, 1, 0, '0', 1, '精彩图片', '', '', 3, 4, 0, '6', '', '', '', 0),(7, 1, 0, '0', 1, '首页幻灯', '', '', 0, 5, 0, '7', '', '', '', 0),(8, 1, 0, '0', 1, '友情链接', '', '', 3, 2, 0, '8', '', '', '', 0),(9, 1, 0, '0', 0, '技术支持', 'http://www.imtcms.com', '', 3, 0, 0, '9', '', '', '0', 0);
...
REPLACE INTO `{dbprefix}space_slides` (`id`, `catid`, `title`, `uid`, `author`, `hits`, `status`, `inputtime`, `updatetime`, `displayorder`, `image`, `link`) VALUES (1, 7, '应用开放平台', 1, 'admin', 0, 1, 1377949237, 1377949237, 0, 'http://www.imtcms.com/statics/admin/images/index_banner1.jpg', 'http://store.dayrui.com'),(2, 7, '群站多语言管理', 1, 'admin', 0, 1, 1377949258, 1377949258, 0, 'http://www.imtcms.com/dayrui/statics/dayrui/images/index_banner2.jpg', 'http://www.imtcms.com/cms/'),(3, 7, 'ImtCMS 一套神奇的系统', 1, 'admin', 0, 1, 1377949306, 1377949306, 0, 'http://www.imtcms.com/dayrui/statics/dayrui/images/index_banner3.jpg', 'http://www.imtcms.com/');
...
(1, 'ImtCMS设计室', 'http://www.imtcms.com/assets/logo.png', 'default', 'ImtCMS设计室-专业技术团队', 'ImtCMS,网站建设,内容管理系统', 'ImtCMS v2（简称v2）是一款开源的跨平台网站内容管理系统，以“实用+好用”为基本产品理念，提供从内容发布、组织、传播、互动和数据挖掘的网站一体化解决方案', '<p>ImtCMS v2（简称v2）是一款开源的跨平台网站内容管理系统，以“实用+好用”为基本产品理念，提供从内容发布、组织、传播、互动和数据挖掘的网站一体化解决方案。系统基于CodeIgniter框架，具有良好扩展性和管理性，可以帮助您在各种操作系统与运行环境中搭建各种网站模型而不需要对复杂繁琐的编程语言有太多的专业知识，系统采用UTF-8编码，采取(语言-代码-程序)两两分离的技术模式，全面使用了模板包与语言包结构，为用户的修改提供方便，网站内容的每一个角落都可以在后台予以管理，是一套非常适合用做系统建站或者进行二次开发的程序核心。</p>', '<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cdiv id=''cnzz_stat_icon_5629330''%3E%3C/div%3E%3Cscript src=''" + cnzz_protocol + "s9.cnzz.com/stat.php%3Fid%3D5629330%26show%3Dpic2'' type=''text/javascript''%3E%3C/script%3E"));</script>', '<p>扣扣咨询：135977378 电子邮箱：ImtCMS@qq.com</p>某某某公司版权所有，ICP备案0000001<p><br /></p>', 888888, 1, 1377949585);
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(9, 1, 0, '0', 0, '技术支持', 'http://www.imtcms.com', 3, 0, 0, '9');
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(18, 2, 0, '0', 0, '技术支持', 'http://www.imtcms.com', 3, 0, 0, '18');
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(27, 3, 0, '0', 0, '技术支持', 'http://www.imtcms.com', 3, 0, 0, '27');
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(36, 4, 0, '0', 0, '技术支持', 'http://www.imtcms.com', 3, 0, 0, '36');
